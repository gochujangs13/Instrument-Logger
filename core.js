...
const T = {
  ko: {
    ...
    // ── PST-3202 ─────────────────────────────────────────────
    pst_conn_label: '장비 연결 (Web Serial)',
    pst_output_title: '전원 출력 제어',
    pst_btn_start: '⚡ 시작',
    pst_btn_stop: '⚡ 정지',
    pst_auto_stop: '0A 자동 정지',
    pst_auto_stop_tip: '시작 후 2초가 지났는데도 모든 채널 전류가 0.000A면 출력을 자동 정지합니다.',
    pst_track_title: '트래킹 모드',
    pst_tm0: '독립 (Independent)',
    pst_tm1: '병렬 트래킹 (Parallel) ⚠️',
    pst_tm2: '직렬 트래킹 (Series) ⚠️',
    pst_tm0_tip: '독립 모드: 각 채널을 독립적으로 설정·측정합니다.',
    pst_tm1_tip: '⚠️ CH1·CH2 단자를 실제로 병렬 결선해야 합니다.\n두 채널이 하나의 회로로 묶이므로 채널별 독립 측정 불가.\n용도: 전류 공급 능력을 2배(최대 4A)로 확장할 때.',
    pst_tm2_tip: '⚠️ CH1·CH2 단자를 실제로 직렬 결선해야 합니다.\n두 채널이 하나의 회로로 묶이므로 채널별 독립 측정 불가.\n용도: 전압 범위를 2배(최대 64V)로 확장할 때.',
    pst_track0: '독립', pst_track1: '병렬', pst_track2: '직렬',
    pst_syslog: '시스템 로그',
    pst_sel_badge: '선택됨',
    pst_use: '사용',
    pst_cv_tab: '⚡ 전압 제어',
    pst_cc_tab: '🔋 전류 제어',
    pst_vset_label: '전압 설정',
    pst_ilimit_label: '전류 제한',
    pst_itarget_label: '목표 전류',
    pst_cc_notice: '🔋 전류 제어 모드: 전압을 채널 최댓값({V}V)으로 걸어두고 전류만 목표값으로 유지합니다',
    pst_ocp_label: 'OCP 보호',
    pst_ocp_tip: '과전류 보호 (OCP)\n측정 전류가 설정한 전류 한계치를 초과하면\n출력을 자동으로 차단합니다.',
    pst_ovp_btn: 'OVP 설정',
    pst_ovp_tip: '과전압 보호 (OVP)\n측정 전압이 설정한 전압 한계치를 초과하면\n출력을 자동으로 차단합니다.\n클릭하면 한계값을 입력할 수 있습니다.',
    pst_fixed_tab: '📌 고정값',
    pst_cycle_tab: '🔄 사이클',
    pst_mode_fixed: '고정값',
    pst_mode_cycle: '사이클',
    pst_sync_txt: '동기화',
    pst_sync_tip: '1번채널을 입력하면 전압/전류값이 2번 채널에도 동일하게 적용됩니다.\n3채널 포함 시: 전압 최대 6V, 전류 최대 2A 범위 내에서 동기화됩니다.',
    pst_sync_ch3_tip: '3채널 포함 (전압 ≤6V / 전류 ≤2A)',
    pst_ce_title: '🔄 사이클 시퀀스 편집기',
    pst_ce_editing: '— CH {n} 편집 중',
    pst_ce_add_title: '단계 추가',
    pst_ce_cc_notice: '🔋 전류 제어: 각 단계마다 전압은 채널 최댓값으로 자동 설정됩니다',
    pst_ce_v: '전압',
    pst_ce_i: '전류',
    pst_ce_time: '시간 (초)',
    pst_ce_time_ph: '초',
    pst_ce_add_btn: '➕ 단계 추가',
    pst_ce_loops: '반복 횟수',
    pst_ce_est: '⏱️ 예상 소요 시간:',
    pst_ce_ch_start: '▶ CH시작',
    pst_ce_ch_stop: '■ CH중지',
    pst_ce_all_start: '▶ 전체 시작',
    pst_ce_all_stop: '■ 전체 중지',
    pst_ce_live_v: '실시간 전압',
    pst_ce_live_i: '실시간 전류',
    pst_th_vt: '목표 전압',
    pst_th_it: '목표 전류',
    pst_th_wait: '대기 시간',
    pst_del: '삭제',
    pst_ce_empty: '단계가 없습니다. 왼쪽에서 단계를 추가하세요.',
    pst_ce_status: 'CH{c} ▶ 단계 {i}/{n} | 남은 시간 {r}초 | 사이클 {l}/{L}',
    pst_u_h: '시간', pst_u_m: '분', pst_u_s: '초',
    pst_graph_title: '📈 실시간 그래프',
    pst_viewing: '📌 기록 보기 중',
    pst_viewing_exit_hint: '클릭하면 기록 보기를 종료하고 실시간 측정 화면으로 돌아갑니다',
    pst_test_time: '테스트 시간',
    pst_graph_reset: '🔄 그래프 초기화',
    pst_graph_reset_confirm: '그래프 데이터를 초기화하시겠습니까?',
    pst_dt_save: '💾 저장',
    pst_dt_delsel: '🗑️ 선택 삭제',
    pst_list_export_btn: '📤 목록 내보내기',
    pst_list_import_btn: '📂 목록 가져오기',
    pst_import_invalid: '올바른 평가 목록 파일(.json)이 아닙니다.',
    pst_import_done_title: '가져오기 완료',
    pst_import_done_msg: '{added}개 추가됨, {skipped}개는 중복이라 제외됨.',
    pst_log_list_exported: '평가 목록 {n}개를 파일로 내보냄: {f}',
    pst_log_list_imported: '평가 목록 가져오기 완료 — 추가 {added}개, 중복 제외 {skipped}개',
    pst_th_date: '날짜',
    pst_th_name: '제품명',
    pst_th_num: '번호',
    pst_th_track: '트래킹모드',
    pst_th_mode: '모드',
    pst_th_stress: '강압 조건 (kg)',
    pst_th_aging: '에이징시간',
    pst_th_cond: '전압 / 전류 / 시간 조건',
    pst_th_cond2: '조건',
    pst_th_imax: '전류 최대값',
    pst_th_duration: '소요 시간',
    pst_all: '전체',
    pst_none: '표시 안 함',
    pst_n_selected: '{N}개 선택',
    pst_select_all: '전체 선택',
    pst_select_none: '전체 해제',
    pst_empty_evals: '완료된 평가가 없습니다. "정지"를 눌러 측정을 마치면 여기에 기록됩니다.',
    pst_empty_evals2: '완료된 평가가 없습니다.',
    pst_empty_filter: '필터 조건에 맞는 평가 기록이 없습니다.',
    pst_sample: '샘플',
    pst_prot_title: '보호 모드 발동',
    pst_prot_close: '❌ 보호 모드 해제 및 닫기',
    pst_confirm_title: '평가 기록 삭제',
    pst_confirm_msg: '정말로 선택한 평가 기록을 삭제하시겠습니까?',
    pst_cancel: '취소',
    pst_ok: '확인',
    pst_overwrite_title: '평가 기록 덮어쓰기',
    pst_overwrite_confirm: '"{name}" 기록에 이미 저장된 측정 데이터가 있습니다.\n새로 측정한 결과로 덮어쓰시겠습니까?',
    pst_overwrite_ok: '덮어쓰기',
    pst_log_overwrite_cancel: '덮어쓰기 취소 — 새 기록으로 별도 저장됩니다.',
    pst_apply: '적용',
    pst_tab_title: '이미 다른 탭/창에서 실행 중',
    pst_tab_msg: 'PST-3202 컨트롤러는 한 번에 하나의 탭에서만 사용할 수 있습니다.\n(장치 COM 포트 충돌 및 데이터 저장 충돌 방지)\n\n다른 탭/창을 닫은 뒤 아래 버튼을 눌러 새로고침 해주세요.',
    pst_tab_reload: '🔄 새로고침',
    pst_warn_title: '입력 범위 초과',
    pst_info_title: '완료',
    pst_range: '허용 범위',
    pst_track_img_alt: '트래킹 결선 이미지',
    pst_v_adj: '↩ 최대 {V}V로 자동 조정됨',
    pst_i_adj: '↩ 최대 {A}A로 자동 조정됨',
    pst_v3_adj: '↩ 3채널 최대 전압({V}V)으로 조정됩니다',
    pst_ovp_below_vset: '⚠ OVP는 설정 전압({V}V) 이상이어야 하므로 동일하게 조정됨',
    pst_v_ovp_limited: '⚠ OVP 한계치({V}V)로 전압이 제한되었습니다',
    pst_v3_adj_all: '↩ 3채널 최대 전압({V}V)으로 전체 채널 조정됩니다',
    pst_v_min: '⚠ 0V 이상 입력',
    pst_i_min: '⚠ 0A 이상 입력',
    pst_v_exceed: '전압 허용치 범위를 초과했습니다.\n허용 범위: 0 ~ {V} V',
    pst_i_exceed: '전류 허용치 범위를 초과했습니다.\n허용 범위: 0 ~ {A} A',
    pst_t_exceed: '시간 허용치 범위를 초과했습니다.\n허용 범위: 최소 1초 이상',
    pst_connect_first: '장치를 먼저 연결해 주세요.',
    pst_need_conn: '연결 필요',
    pst_no_steps: '단계 없음',
    pst_no_steps_ch: 'CH{n}에 설정된 사이클 단계가 없습니다.\n왼쪽 필드에서 단계를 추가해주세요.',
    pst_no_steps_any: '사이클로 동작시킬 채널의 단계가 없습니다.\n먼저 단계를 구성해 주세요.',
    pst_ovp_invalid: '유효한 OVP 값을 입력하세요.\n허용 범위: 0 ~ {V} V',
    pst_check_items: '삭제할 항목을 체크해 주세요.',
    pst_del_confirm: '{n}개 평가 기록을 삭제하시겠습니까?',
    pst_export_select: '내보낼 평가 항목을 체크박스로 선택해 주세요.',
    pst_excel_saved: '엑셀 파일이 프로그램 폴더에 성공적으로 저장되었습니다!\n파일명: {f}',
    pst_excel_title: '📊 엑셀 내보내기 완료',
    pst_saved_msg: '데이터 테이블의 현재 상태가 성공적으로 디스크에 저장되었습니다!',
    pst_saved_title: '💾 저장 완료',
    pst_save_err: '저장 중 오류가 발생했습니다: ',
    pst_x_time: '시간(s)',
    pst_x_v: '전압(V)',
    pst_x_i: '전류(A)',
    pst_x_vsum: '전압(합계,V)',
    ...
    pst_srv_err: '서버 응답 오류',
    pst_save_fail_generic: '저장 실패',
    pst_on: '켜짐', pst_off: '꺼짐',
    pst_log_synced: '동기화',
    pst_log_sync12_on: 'CH1→CH2 동기화 ON: 전압/전류/OCP/OVP 일괄 적용',
    pst_log_sync12_off: 'CH1→CH2 설정 동기화 OFF',
    pst_log_sync3_on: 'CH1→CH3 동기화 ON: 전압(≤6V)/전류(≤2A)/OCP/OVP/모드 일괄 적용',
    pst_log_sync3_off: 'CH1→CH3 설정 동기화 OFF',
    pst_log_cy_auto_on_ch: '[사이클] CH{n}: 출력 자동 ON',
    pst_log_cy_auto_on: '[사이클] 출력 자동 ON',
    pst_log_cy_stop: '[사이클] CH{n} 중지',
    pst_log_cy_step: '[사이클] CH{n} 단계 {i}: {v}V {a}A ({t}초)',
    pst_log_cy_done: '[사이클] CH{n} 완료',
    pst_log_cy_alldone: '[사이클] 모든 채널 사이클 완료 — 출력 자동 정지',
    pst_log_as_trip: '시작 2초 경과 후 모든 채널 전류 0.000A — 출력 자동 정지',
    pst_log_eval_over: '평가 기록 덮어씀: {name} (최대 전류 {i}A)',
    pst_log_eval_saved: '평가 기록 저장됨: {name} (최대 전류 {i}A)',
    pst_log_delsel: '선택 삭제 클릭됨 (체크된 항목 수: {n})',
    pst_log_del_cancel: '삭제 취소됨',
    pst_log_deleting: '{n}개 항목 삭제 진행 중...',
    pst_log_excel_ok: 'Excel로 {n}개 평가 내보냄 (프로그램 폴더에 저장됨): {f}',
    pst_log_srv_fb: '로컬 서버 저장 실패, 브라우저 다운로드로 대체합니다: ',
    pst_log_excel_fail: '엑셀 내보내기 실패: ',
    pst_log_manual_saved: '평가 기록 수동 저장 완료',
    pst_log_save_fail: '평가 기록 저장 실패: ',
    pst_log_loaded: '이전 평가 기록 {n}개를 불러왔습니다.',
    pst_log_load_fail: '이전 평가 기록을 불러오지 못했습니다.',
    pst_log_connected: '연결 완료. 트래킹 모드: 독립',
    pst_log_disconnected: '장치 연결이 끊어졌습니다.',
    pst_log_graph_reset: '그래프 데이터 초기화됨',
  },
  en: {
    // topbar / launcher
    ...
    // ── PST-3202 ─────────────────────────────────────────────
    pst_conn_label: 'Device Connection (Web Serial)',
    pst_output_title: 'Power Output Control',
    pst_btn_start: '⚡ Start',
    pst_btn_stop: '⚡ Stop',
    pst_auto_stop: '0A Auto-Stop',
    pst_auto_stop_tip: 'Automatically stops output if all channel currents are still 0.000A two seconds after start.',
    pst_track_title: 'Tracking Mode',
    pst_tm0: 'Independent',
    pst_tm1: 'Parallel Tracking ⚠️',
    pst_tm2: 'Series Tracking ⚠️',
    pst_tm0_tip: 'Independent mode: each channel is set and measured independently.',
    pst_tm1_tip: '⚠️ CH1·CH2 terminals must be physically wired in parallel.\nBoth channels form one circuit — no independent per-channel measurement.\nUse: doubling current capability (up to 4A).',
    pst_tm2_tip: '⚠️ CH1·CH2 terminals must be physically wired in series.\nBoth channels form one circuit — no independent per-channel measurement.\nUse: doubling voltage range (up to 64V).',
    pst_track0: 'Indep.', pst_track1: 'Parallel', pst_track2: 'Series',
    pst_syslog: 'System Log',
    pst_sel_badge: 'Selected',
    pst_use: 'Use',
    pst_cv_tab: '⚡ Voltage Ctrl',
    pst_cc_tab: '🔋 Current Ctrl',
    pst_vset_label: 'Voltage Setting',
    pst_ilimit_label: 'Current Limit',
    pst_itarget_label: 'Target Current',
    pst_cc_notice: '🔋 Current control mode: voltage is held at the channel max ({V}V) and only current is regulated to the target',
    pst_ocp_label: 'OCP Protect',
    pst_ocp_tip: 'Over-Current Protection (OCP)\nAutomatically cuts the output when measured current\nexceeds the set current limit.',
    pst_ovp_btn: 'OVP Setup',
    pst_ovp_tip: 'Over-Voltage Protection (OVP)\nAutomatically cuts the output when measured voltage\nexceeds the set voltage limit.\nClick to enter the limit value.',
    pst_fixed_tab: '📌 Fixed',
    pst_cycle_tab: '🔄 Cycle',
    pst_mode_fixed: 'Fixed',
    pst_mode_cycle: 'Cycle',
    pst_sync_txt: 'Sync',
    pst_sync_tip: 'Values entered on CH1 are applied to CH2 as well.\nWith CH3 included: synced within max 6V / max 2A.',
    pst_sync_ch3_tip: 'Include CH3 (voltage ≤6V / current ≤2A)',
    pst_ce_title: '🔄 Cycle Sequence Editor',
    pst_ce_editing: '— Editing CH {n}',
    pst_ce_add_title: 'Add Step',
    pst_ce_cc_notice: '🔋 Current control: voltage is automatically set to the channel max for each step',
    pst_ce_v: 'Voltage',
    pst_ce_i: 'Current',
    pst_ce_time: 'Time (s)',
    pst_ce_time_ph: 's',
    pst_ce_add_btn: '➕ Add Step',
    pst_ce_loops: 'Repeat Count',
    pst_ce_est: '⏱️ Estimated Duration:',
    pst_ce_ch_start: '▶ Start CH',
    pst_ce_ch_stop: '■ Stop CH',
    pst_ce_all_start: '▶ Start All',
    pst_ce_all_stop: '■ Stop All',
    pst_ce_live_v: 'Live Voltage',
    pst_ce_live_i: 'Live Current',
    pst_th_vt: 'Target V',
    pst_th_it: 'Target I',
    pst_th_wait: 'Duration',
    pst_del: 'Delete',
    pst_ce_empty: 'No steps yet. Add a step on the left.',
    pst_ce_status: 'CH{c} ▶ Step {i}/{n} | {r}s left | Cycle {l}/{L}',
    pst_u_h: 'h', pst_u_m: 'm', pst_u_s: 's',
    pst_graph_title: '📈 Real-time Graph',
    pst_viewing: '📌 Viewing Record',
    pst_viewing_exit_hint: 'Click to exit record view and return to the live measurement screen',
    pst_test_time: 'Test Time',
    pst_graph_reset: '🔄 Reset Graph',
    pst_graph_reset_confirm: 'Reset all graph data?',
    pst_dt_save: '💾 Save',
    pst_dt_delsel: '🗑️ Delete Selected',
    pst_list_export_btn: '📤 Export List',
    pst_list_import_btn: '📂 Import List',
    pst_import_invalid: 'Not a valid evaluation list file (.json).',
    pst_import_done_title: 'Import Complete',
    pst_import_done_msg: '{added} added, {skipped} skipped as duplicates.',
    pst_log_list_exported: 'Exported {n} evaluation record(s) to file: {f}',
    pst_log_list_imported: 'Evaluation list import complete — {added} added, {skipped} duplicates skipped',
    pst_th_date: 'Date',
    pst_th_name: 'Product Name',
    pst_th_num: 'No.',
    pst_th_track: 'Tracking',
    pst_th_mode: 'Mode',
    pst_th_stress: 'Stress Cond. (kg)',
    pst_th_aging: 'Aging Time',
    pst_th_cond: 'Voltage / Current / Time Conditions',
    pst_th_cond2: 'Conditions',
    pst_th_imax: 'Max Current',
    pst_th_duration: 'Duration',
    pst_all: 'All',
    pst_none: 'None shown',
    pst_n_selected: '{N} selected',
    pst_select_all: 'Select All',
    pst_select_none: 'Deselect All',
    pst_empty_evals: 'No completed evaluations. Press "Stop" to finish a measurement and it will be recorded here.',
    pst_empty_evals2: 'No completed evaluations.',
    pst_empty_filter: 'No evaluation records match the filter.',
    pst_sample: 'Sample',
    pst_prot_title: 'Protection Triggered',
    pst_prot_close: '❌ Clear Protection & Close',
    pst_confirm_title: 'Delete Evaluation Records',
    pst_confirm_msg: 'Really delete the selected evaluation records?',
    pst_cancel: 'Cancel',
    pst_ok: 'OK',
    pst_overwrite_title: 'Overwrite Evaluation Record',
    pst_overwrite_confirm: 'The record "{name}" already has saved measurement data.\nOverwrite it with the new measurement?',
    pst_overwrite_ok: 'Overwrite',
    pst_log_overwrite_cancel: 'Overwrite canceled — saved as a separate new record instead.',
    pst_apply: 'Apply',
    pst_tab_title: 'Already Running in Another Tab',
    pst_tab_msg: 'The PST-3202 controller can only be used in one tab at a time.\n(Prevents COM port and data-save conflicts)\n\nClose the other tab/window, then press the button below to reload.',
    pst_tab_reload: '🔄 Reload',
    pst_warn_title: 'Input Out of Range',
    pst_info_title: 'Done',
    pst_range: 'Allowed range',
    pst_track_img_alt: 'Tracking wiring image',
    pst_v_adj: '↩ Auto-adjusted to max {V}V',
    pst_i_adj: '↩ Auto-adjusted to max {A}A',
    pst_v3_adj: '↩ Will be adjusted to the 3-channel max voltage ({V}V)',
    pst_ovp_below_vset: '⚠ OVP must be ≥ the set voltage ({V}V) — adjusted to match',
    pst_v_ovp_limited: '⚠ Voltage limited to the OVP threshold ({V}V)',
    pst_v3_adj_all: '↩ All channels will be adjusted to the 3-channel max voltage ({V}V)',
    pst_v_min: '⚠ Enter 0V or higher',
    pst_i_min: '⚠ Enter 0A or higher',
    pst_v_exceed: 'Voltage is out of the allowed range.\nAllowed range: 0 ~ {V} V',
    pst_i_exceed: 'Current is out of the allowed range.\nAllowed range: 0 ~ {A} A',
    pst_t_exceed: 'Time is out of the allowed range.\nAllowed range: at least 1 second',
    pst_connect_first: 'Please connect the device first.',
    pst_need_conn: 'Connection Required',
    pst_no_steps: 'No Steps',
    pst_no_steps_ch: 'CH{n} has no cycle steps configured.\nAdd steps in the left panel.',
    pst_no_steps_any: 'No channel has cycle steps to run.\nConfigure steps first.',
    pst_ovp_invalid: 'Enter a valid OVP value.\nAllowed range: 0 ~ {V} V',
    pst_check_items: 'Check the items to delete.',
    pst_del_confirm: 'Delete {n} evaluation record(s)?',
    pst_export_select: 'Select the evaluation items to export using the checkboxes.',
    pst_excel_saved: 'Excel file saved to the program folder!\nFilename: {f}',
    pst_excel_title: '📊 Excel Export Complete',
    pst_saved_msg: 'The current data table state was saved to disk successfully!',
    pst_saved_title: '💾 Save Complete',
    pst_save_err: 'An error occurred while saving: ',
    pst_x_time: 'Time(s)',
    pst_x_v: 'Voltage(V)',
    pst_x_i: 'Current(A)',
    pst_x_vsum: 'Voltage(Sum,V)',
    pst_x_isum: 'Current(Avg,A)',
    pst_x_sheet_ch: 'Per Channel',
    ...
    pst_srv_err: 'Server response error',
    pst_save_fail_generic: 'Save failed',
    pst_on: 'ON', pst_off: 'OFF',
    pst_log_synced: 'synced',
    pst_log_sync12_on: 'CH1→CH2 sync ON: voltage/current/OCP/OVP applied together',
    pst_log_sync12_off: 'CH1→CH2 sync OFF',
    pst_log_sync3_on: 'CH1→CH3 sync ON: voltage(≤6V)/current(≤2A)/OCP/OVP/mode applied together',
    pst_log_sync3_off: 'CH1→CH3 sync OFF',
    pst_log_cy_auto_on_ch: '[Cycle] CH{n}: output auto ON',
    pst_log_cy_auto_on: '[Cycle] output auto ON',
    pst_log_cy_stop: '[Cycle] CH{n} stopped',
    pst_log_cy_step: '[Cycle] CH{n} step {i}: {v}V {a}A ({t}s)',
    pst_log_cy_done: '[Cycle] CH{n} complete',
    pst_log_cy_alldone: '[Cycle] all channel cycles complete — output auto stopped',
    pst_log_as_trip: 'All channel currents 0.000A two seconds after start — output auto stopped',
    pst_log_eval_over: 'Evaluation record overwritten: {name} (max current {i}A)',
    pst_log_eval_saved: 'Evaluation record saved: {name} (max current {i}A)',
    pst_log_delsel: 'Delete-selected clicked (checked items: {n})',
    pst_log_del_cancel: 'Deletion cancelled',
    pst_log_deleting: 'Deleting {n} item(s)...',
    pst_log_excel_ok: 'Exported {n} evaluation(s) to Excel (saved in program folder): {f}',
    pst_log_srv_fb: 'Local server save failed, falling back to browser download: ',
    pst_log_excel_fail: 'Excel export failed: ',
    pst_log_manual_saved: 'Evaluation records saved manually',
    pst_log_save_fail: 'Failed to save evaluation records: ',
    pst_log_loaded: 'Loaded {n} previous evaluation record(s).',
    pst_log_load_fail: 'Could not load previous evaluation records.',
    pst_log_connected: 'Connected. Tracking mode: Independent',
    pst_log_disconnected: 'Device disconnected.',
    pst_log_graph_reset: 'Graph data reset',
  },
};
